    ...
    <section class="container">
        <div class="cards">
            <div class="parfum-card">
                <img src="../bilder/0pr_20zs__1ab5s0_030a_oxr49jxxpx2gvr9c.webp" alt="parfum">
                <h3>Versace</h3>
                <p>250,-€</p>
            ...
            <div class="parfum-card">
                <img src="../bilder/0dg4385__32888g_030a.webp" alt="parfum">
                <h3>Tommy</h3>
                <p>129,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/0rb3648m__91673f_030a_qlfqwr8benct4aer.webp" alt="parfum">
                <h3>Prada</h3>
                <p>193,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/0ve4432u__538887_030a.webp" alt="parfum">
                <h3>DIOR</h3>
                <p>190,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/bb0285s-001-cat-xxl.webp" alt="parfum">
                <h3>Kate Spada</h3>
                <p>190,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/gg1278s-002-cat-original.webp" alt="parfum">
                <h3>DIOR</h3>
                <p>190,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/gg0974s-001-cat-original.webp" alt="parfum">
                <h3>CHLOE</h3>
                <p>190,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/gg0113s_001_cat.webp" alt="parfum">
                <h3>Prada</h3>
                <p>190,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/gg0327s_001_cat_cpfpqzljzkgunaro.webp" alt="parfum">
                <h3>Chloe</h3>
                <p>99,06€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/ch0061s-004-cat-xxl.webp" alt="parfum">
                <h3>Guess</h3>
                <p>130,76€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/sl276mica_001_cat_eho7r5yvofgcp0li.webp" alt="parfum">
                <h3>Tommy</h3>
                <p>107,40€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/gu7911_92y_01.webp" alt="parfum">
                <h3>Prada</h3>
                <p>140,00€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
