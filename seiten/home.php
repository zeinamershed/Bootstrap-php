    ...
    <section class="container">
        <div class="cards">
            <div class="parfum-card">
                <img src="../bilder/1199011513-1_200x200.webp" alt="parfum">
                <h3>Windlicht</h3>
                <p>37,-€</p>
            ...
            <div class="parfum-card">
                <img src="../bilder/44531_2_2_200x200.webp" alt="parfum">
                <h3>Tischlampe</h3>
                <p>24,59€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/Einzelbild-Gy3jezba-large_200x200.webp" alt="parfum">
                <h3>Dekohirsch</h3>
                <p>17,50€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/Einzelbild-kyR_U0mp-large_200x200.webp" alt="parfum">
                <h3>Gift</h3>
                <p>4,95€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/795015613_200x200.webp" alt="parfum">
                <h3>Dekohirsch</h3>
                <p>22,-€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/Einzelbild-2fNnYrS5-large_200x200.webp" alt="parfum">
                <h3>Gift</h3>
                <p>4,95€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/linzerHW_200x200.webp" alt="parfum">
                <h3>Kerzen</h3>
                <p>34,-€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/26110_200x200.webp" alt="parfum">
                <h3>Led Kerzen</h3>
                <p>34,-€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="parfum-card">
                <img src="../bilder/Shimmering_Christmas_Tree_Votive-1_200x200.webp" alt="parfum">
                <h3>Kerzen</h3>
                <p>34,-€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
