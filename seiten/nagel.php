    ...
    <section class="container">
        <div class="cards">
            <div class="parfum-card">
                <img src="../bilder/essie-gel-couture-rosatoene-nagellack-13-5-ml-nr--10---sheer-fantasy-30138223.webp" alt="parfum">
                <h3>ESSIE</h3>
                <p>Nagelüberlack</p>
                <p>8,60€</p>
            ...
            <div class="parfum-card">
                <img src="../bilder/opi-null-nagellack-15-ml-rhinestone-red-y-4064665100587.webp" alt="parfum">
                <h3>OPI</h3>
                <p>Nagellack</p>
                <p>8,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/opi-null-nagellack-15-ml-suzi-takes-a-sound-bath-4064665099492.webp" alt="parfum">
                <h3>OPI</h3>
                <p>Nagellack</p>
                <p>7,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/artdeco-nail-care-profi-nagelfeile-2-stk_1.webp" alt="parfum">
                <h3>Artdeco</h3>
                <p>Nagelfeile</p>
                <p>6,45€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/alessandro-striplac-peel-or-soak-top-coat-nagelueberlack-8-ml-rose-glitter-4025087484075.webp" alt="parfum">
                <h3>Alessandro</h3>
                <p>Nagelüberlack</p>
                <p>17,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/alessandro-striplac-travel-kit-no-make-up-day-nagellack-set-1-stk-no-color-4025087480206.webp" alt="parfum">
                <h3>Alessandro</h3>
                <p>nagellackset</p>
                <p>89,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/alessandro-striplac-peel-or-soak-nagelfeile-no_color-4025087484181.webp" alt="parfum">
                <h3>Alessandro</h3>
                <p>Nagelfeile</p>
                <p>19,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/3145891582550_c.webp" alt="parfum">
                <h3>CHANEL</h3>
                <p>Nagelunterlack</p>
                <p>19,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/artdeco-null-nagellackentferner-100-ml-4052136216394.webp" alt="parfum">
                <h3>Artdeco</h3>
                <p>Nagellackentfernen</p>
                <p>19,60€</p>
                <div class="card-button">
                    <svg class="svg-icon" viewBox="0 0 20 20">
                      <path d="M17.72,5.011H8.026c-0.271,0-0.49,0.219-0.49,0.489c0,0.271,0.219,0.489,0.49,0.489h8.962l-1.979,4.773H6.763L4.935,5.343C4.926,5.316,4.897,5.309,4.884,5.286c-0.011-0.024,0-0.051-0.017-0.074C4.833,5.166,4.025,4.081,2.33,3.908C2.068,3.883,1.822,4.075,1.795,4.344C1.767,4.612,1.962,4.853,2.231,4.88c1.143,0.118,1.703,0.738,1.808,0.866l1.91,5.661c0.066,0.199,0.252,0.333,0.463,0.333h8.924c0.116,0,0.22-0.053,0.308-0.128c0.027-0.023,0.042-0.048,0.063-0.076c0.026-0.034,0.063-0.058,0.08-0.099l2.384-5.75c0.062-0.151,0.046-0.323-0.045-0.458C18.036,5.092,17.883,5.011,17.72,5.011z"></path>
            ...
            <div class="parfum-card">
                <img src="../bilder/essie-good-to-go-nagelueberlack-13-ml-3600531539900.webp" alt="parfum">
                <h3>Essie</h3>
                <p>Nagellack</p>
                <p>19,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/essie-rottoene-nagellack-nr-788-ice-scream-and-shout-30158931.webp" alt="parfum">
                <h3>Essie</h3>
                <p>Nagellack</p>
                <p>19,60€</p>
                <div class="card-button">
            ...
            <div class="parfum-card">
                <img src="../bilder/essie-stay-longer-premium-nagelueberlack-13-5-ml-no-color-3600531663414.webp" alt="parfum">
                <h3>NARS</h3>
                <p>Nagellack</p>
                <p>19,60€</p>
                <div class="card-button">
